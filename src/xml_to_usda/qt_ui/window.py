...
def _fracture_preview_trace_payload(settings: FracturePreviewSettings) -> dict[str, object]:
    ...
    return {
        ...
        "detailed_cuts_enabled": fracture.detailed_cuts_enabled,
        "detailed_cut_intensity": fracture.detailed_cut_intensity,
        "detailed_cut_scale": fracture.detailed_cut_scale,
        "detailed_cut_density": fracture.detailed_cut_density,
        "detailed_cut_max_bend_angle": fracture.detailed_cut_max_bend_angle,
    ...
    def open_fracture_preview_dialog(self) -> None:
        ...
        self._append_runtime_log(
            ...
            "\n".join(
                (
                    ...
                    f"detailed_cuts_enabled={settings.fracture.detailed_cuts_enabled}",
                    f"detailed_cut_intensity={settings.fracture.detailed_cut_intensity}",
                    f"detailed_cut_scale={settings.fracture.detailed_cut_scale}",
                    f"detailed_cut_density={settings.fracture.detailed_cut_density}",
                    f"detailed_cut_max_bend_angle={settings.fracture.detailed_cut_max_bend_angle}",
        ...
        self._trace(
            ...
            data={
                ...
                "detailed_cuts_enabled": settings.fracture.detailed_cuts_enabled,
                "detailed_cut_intensity": settings.fracture.detailed_cut_intensity,
                "detailed_cut_scale": settings.fracture.detailed_cut_scale,
                "detailed_cut_density": settings.fracture.detailed_cut_density,
                "detailed_cut_max_bend_angle": settings.fracture.detailed_cut_max_bend_angle,
