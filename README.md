...
- Replace heuristic XML extraction with sample-driven observed schema adapters.
- Add contract tests against real `unreal/schema.usda`.
- Add export guide once real XML samples are validated end-to-end.
